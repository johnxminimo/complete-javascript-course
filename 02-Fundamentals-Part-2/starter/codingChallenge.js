...
console.log(
  `${personWithBiggerBMI[`firstName`]}'s BMI (${
    personWithBiggerBMI[`bmi`]
  }) is higher than ${personWithSmallerBMI[`firstName`]}'s (${
    personWithSmallerBMI[`bmi`]
  }).`
);
...
hasDriversLicense
  ? console.log(`John has a drivers license`)
  : console.log(`John does not have a drivers license`);
